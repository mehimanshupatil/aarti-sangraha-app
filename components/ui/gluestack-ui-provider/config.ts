...
export const config = {
  light: vars({
    /* App brand colors */
    '--color-app-primary': '184 69 18',
    '--color-app-on-primary': '255 251 242',
    '--color-app-text': '58 43 26',
    '--color-app-accent': '196 122 58',
    '--color-app-bg': '250 244 232',
    '--color-app-surface': '243 234 213',
    '--color-app-border': '196 164 122',
  ...
  dark: vars({
    /* App brand colors */
    '--color-app-primary': '221 170 85',
    '--color-app-on-primary': '28 24 18',
    '--color-app-text': '232 217 188',
    '--color-app-accent': '204 122 58',
    '--color-app-bg': '28 24 18',
    '--color-app-surface': '38 32 24',
    '--color-app-border': '221 170 85',
